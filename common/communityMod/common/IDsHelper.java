...
public class IDsHelper {
	...
	public static void runConfiguration(Configuration config) {
		...
		titaniumBlockID = config.get(blockids, "Titanium Block ID", 704)
				.getInt();
		...
		bituminousOreID = config.get(blockids, "Bituminous Ore ID", 710)
				.getInt();
		anthraciteOreID = config.get(blockids, "Anthracite Ore ID", 711)
				.getInt();
		...
		franciumBlockID = config.get(blockids, "Francium Block ID", 717)
				.getInt();
		...
		titaniumIngotID = config.get(itemids, "Titanium Ingot ID", 1001)
				.getInt();
		...
		bituminousCoalID = config.get(itemids, "Bituminous Coal ID", 1005)
				.getInt();
		anthraciteCoalID = config.get(itemids, "Anthracite ID", 1006).getInt();
		platinumIngotID = config.get(itemids, "Platinum Ingot ID", 1007)
				.getInt();
		tungstenIngotID = config.get(itemids, "Tungsten Ingot ID", 1008)
				.getInt();
		...
		franciumIngotID = config.get(itemids, "Francium Ingot ID", 1011)
				.getInt();
		cosileadiumAlloyID = config.get(itemids, "Cosileadium Alloy ID", 1012)
				.getInt();
		...
		liquidConcreteStillID = config.get(liquidids,
				"Liquid Concrete Still ID", 2001).getInt();
		liquidConcreteFlowingID = config.get(liquidids,
				"Liquid Concrete Flowing ID", 2000).getInt();
	}
