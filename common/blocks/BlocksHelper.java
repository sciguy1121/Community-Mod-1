...
public class BlocksHelper {
	...
	public static void setupBlocks() {
        ...
        uraniumOre = new BlockOre(IDsHelper.uraniumOreID, "UraniumOre").setHardness(19F).setResistance(23F).setUnlocalizedName("UraniumOre").setCreativeTab(CommunityMod.modTab);
