...
public class BlockLavaFurnace extends BlockContainer
{
	...
	public BlockLavaFurnace(int par1, int par2, boolean active) 
	{
	...
	public TileEntity createNewTileEntity(World var1) 
	{
	  ...
	  @Override
		...
		public void onNeighborBlockChange(World world, int x, int y, int z, int id) 
		{
			...
			{
				world.setBlockWithNotify(x, y, z, CommunityMod.lavafurnaceactive.blockID);
			} else
			{
				world.setBlockWithNotify(x, y, z, CommunityMod.lavafurnace.blockID);
			}
		}
